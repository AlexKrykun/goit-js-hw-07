...
const rendedNewImg = () => {
  const renderedImg = images.reduce(
    (html, img) =>
      html +
      `
  <li class = "gallery-item" title = "${img.alt}">
    <img class = "gallery-item-img" alt = "${img.alt}" src = ${img.url} width = "1128" height = "752">
  </li>`,
    ""
  );
  container.innerHTML = renderedImg;
};
